...
namespace DateSystem
{
    class CepF
    {
        ...
        public CepF(int ID_CEP, int CEPC, string TIPO_LOGRADOURO, string ENDERECO, string NUMERO, string COMPLEMENTO, string BAIRRO, string CIDADE, String SIGLA_CIDADE)
        {
