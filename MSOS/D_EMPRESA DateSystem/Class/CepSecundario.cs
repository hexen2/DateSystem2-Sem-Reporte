...
namespace DateSystem
{
    class CepSecundario
    {
        ...
        public CepSecundario(int ID_CEP, int CEPC, string TIPO_LOGRADOURO, string ENDERECO, string NUMERO, string COMPLEMENTO, string BAIRRO, string CIDADE, String SIGLA_CIDADE)
        {
