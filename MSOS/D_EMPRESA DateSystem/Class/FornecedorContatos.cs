...
{
    class FornecedorContatos
    {
        public FornecedorContatos()
        {
            this.IdContatof = 0;
            this.IdFornecedor = 0;
            this.Nome = "";
        ...
        public FornecedorContatos(int ID_CONTATOF, int ID_FORNECEDOR, int SITUACAO, string NOME, string ABREVIACAO, String TELEFONE, string TELEFONE2, string CELULAR, string CELULAR2, string EMAIL,
           string OBSERVACAO)
        {
