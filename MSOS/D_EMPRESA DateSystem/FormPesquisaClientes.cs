    ...
    public partial class FormPesquisaClientes : Form
    {
        ...
        public void PesquisaCliente()
        {
            ...
            if (radioButtonTodos.Checked)
            {
                ...
                SqlDataAdapter da1 = new SqlDataAdapter("EXEC D_ConsultaTodosCliente " + situacao, conn);
            ...
            if (radioButtonPesquisarMS.Checked)
            {
                ...
                {
                    //SELECIONA POR TODOS OS 
                    SqlDataAdapter da1 = new SqlDataAdapter("EXEC '" + txtPesquisaMsCliente.Text + "'," + situacao + ";", conn);
                    DataSet ds1 = new DataSet();
                    da1.Fill(ds1);
