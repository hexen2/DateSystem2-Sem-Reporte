...
{ 
    public partial class FormCadastroClientes : Form
    {
        ...
        //SqlConnection connetionString = new SqlConnection("Data Source=" + this.NomeServidor + ";Initial Catalog=MSOS;Persist Security Info=True;User ID=sa;Password=dellm@ster2016;");
