...
namespace MSOS
{
    public partial class FormPrincipal : Form
    {
        ...
        private void teste1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            FormPesquisaClientes FormClientesCadastro = new FormPesquisaClientes();
            // Set the Parent Form of the Child window.
            FormClientesCadastro.MdiParent = this;
            // Display the new form.
            FormClientesCadastro.Show();
        ...
        {
            FecharTodosFormulario();
            FormPesquisaFornecedor FormFornecedorCadastro = new FormPesquisaFornecedor();
            // Set the Parent Form of the Child window.
            FormFornecedorCadastro.MdiParent = this;
            // Display the new form.
            FormFornecedorCadastro.Show();
            FormFornecedorCadastro.Top = 0;
            FormFornecedorCadastro.Left = 0;
        }
    }
}
