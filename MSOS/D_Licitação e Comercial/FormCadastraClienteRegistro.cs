                    ...
                    if (radioButtonPessoaFisica.Checked == true)
                    {
                        ...
                        else if (!CepPrincipal.Equals("_____-___"))
                        {
                            if (CepManual == 0)
                            {
                                ...
                                {
                                    if ((Numero(txtNumero, errorProviderCadastraClienteRegistro) == true))
                                    {
                                        ...
                                        else if (!CepSecundarioT.Equals("_____-___"))
                                        {
                                            if (CepManualSe == 0)
                                            {
                                                ...
                                                {
                                                    if ((Numero2(txtBairroNumero, errorProviderCadastraClienteRegistro) == true))
                                                    {
                                                        verificador = true;
                                                        CepSecundario = true;
                                                    }
                                            ...
                                            if (CepManualSe == 1)
                                            {
                                                if ((Cep2(txtCepCliente, errorProviderCadastraClienteRegistro) == true) && (Endereco2(txtEnderecoCliente, errorProviderCadastraClienteRegistro) == true) &&
                                                       (Numero2(txtBairroNumero, errorProviderCadastraClienteRegistro) == true) && (bairro2(txtBairroCliente, errorProviderCadastraClienteRegistro) == true) &&
                            ...
                            if (CepManual == 1)
                            {
                                ...
                                (Numero(txtNumero, errorProviderCadastraClienteRegistro) == true) && (bairro(txtBairro, errorProviderCadastraClienteRegistro) == true) &&
                                (Cidade(txtCidade, errorProviderCadastraClienteRegistro) == true))
                                {
                                    if (CepSecundarioT.Equals("_____-___"))
                                    {
                                        verificador = true;
                    ...
                    if (radioButtonPessoaJuridica.Checked == true)
                    {
                        if (SiteOFF == 0)
                        {
                            ...
                            else if (!CepSecundarioT.Equals("_____-___"))
                            {
                                ...
                                if (CepManualSe == 1)
                                {
                                    if ((Endereco2(txtEnderecoCliente, errorProviderCadastraClienteRegistro) == true) &&
                                   (Numero2(txtBairroNumero, errorProviderCadastraClienteRegistro) == true) && (bairro2(txtBairroCliente, errorProviderCadastraClienteRegistro) == true) &&
                                   (Cidade2(txtCidadeCliente, errorProviderCadastraClienteRegistro) == true))
                                    {
                                        verificador = true;
                                    ...
                                    (Cidade(txtCidade, errorProviderCadastraClienteRegistro) == true))
                                    {
                                        ...
                                        else if (!CepSecundarioT.Equals("_____-___"))
                                        {
                                            ...
                                            if (CepManualSe == 1)
                                            {
                                                ...
                                                if (!CepSecundarioT.Equals("_____-___"))
                                                {
                                                    if ((Endereco2(txtEnderecoCliente, errorProviderCadastraClienteRegistro) == true) && (Numero2(txtBairroNumero, errorProviderCadastraClienteRegistro) == true) && (bairro2(txtBairroCliente, errorProviderCadastraClienteRegistro) == true) &&
                                                       (Cidade2(txtCidadeCliente, errorProviderCadastraClienteRegistro) == true))
                                                    {
                                                        verificador = true;
