...
namespace DateSystem
{
    class FuncionarioOS
    {
        ...
        public FuncionarioOS(int ID_FUNCIONARIO, int ID_RE, int SITUACAO, string NOME, string ABREVIACAO, String TELEFONE, string TELEFONE2, string CELULAR, string CELULAR2, string EMAIL,
